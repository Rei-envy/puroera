...
# アプリケーションを作成した背景
ペルソナを自分とし、自分がプログラミング学習中にエラー解決に時間がかかることと、分からないことに対して、辛さを感じていたことを課題としました。<br>
課題の解決のために、誰かのエラーを解決した方法を教えてもらうことが必要だと考えました。また、解決方法が共有されていない場合は、質問をし経験者に教えてもらえるようにする必要もあると考えました。<br>
また、既存のqiitaやteratailなどのエンジニアに質問できるプラットフォームでは、コミュニケーションを取るためにTwitterなどのSNSでフォローをしてDMを送るという手間がかかると感じたため、チャットルームもつけることにしました。
